...
| **DelayedDelicensingEnabled** | Write | Boolean | The DelayedDelicensingEnabled parameter enables or disables a 30 day grace period for Exchange Online license removals from mailboxes. | |
...
| **EndUserMailNotificationForDelayedDelicensingEnabled** | Write | Boolean | The EndUserMailNotificationForDelayedDelicensingEnabled parameter enables or disables periodic email warnings to affected users that have pending Exchange Online license removal requests on their mailboxes. | |
...
| **TenantAdminNotificationForDelayedDelicensingEnabled** | Write | Boolean | The TenantAdminNotificationForDelayedDelicensingEnabled parameter enables or disables weekly admin Service Health advisory notifications that are sent to admins. | |
