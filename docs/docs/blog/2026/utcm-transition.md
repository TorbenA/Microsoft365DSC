...
```json
GET /admin/configurationManagement/configurationSnapshots('9125b3ac-2895-4af7-b488-d6bbf34f3e7b')
{
    "@odata.context": "...",
...
{
    "@odata.context": "https://canary.graph.microsoft.com/testprodbetaxtasdf/$metadata#admin/configurationManagement/configurationDrifts(id,resourceType,firstReportedDateTime,status,resourceInstanceIdentifier,driftedProperties,monitorId)",
    "value": [
        {
